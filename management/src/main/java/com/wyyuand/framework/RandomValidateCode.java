...
public class RandomValidateCode {
    ...
    /**
     *  http://127.0.0.1:8080/news/vc?type=show&createTypeFlag=nl
     * @param request
     * @param response
...
//        String random = drawRandomNum((Graphics2D) g,"l");//生成纯字母的验证码图片
        String random = drawRandomNum((Graphics2D) g);//根据客户端传递的createTypeFlag标识生成验证码图片
        //7.将随机数存在session中
    ...
    private String drawRandomNum(Graphics2D g, String... createTypeFlag) {
        ...
        //createTypeFlag  ch 截取汉字   nl 截取数字和字母的组合  n l可单独传递
